...
class FeaturedPostMetaVCWP {
	...
	function add_custom_meta_boxes( $post ) {
		...
		foreach ( $this->included_post_types as $post_type ) {
			add_meta_box( "global_featured_content_meta_box", 'Global Featured Content', array( &$this, 'global_featured_content_meta_box' ), $post_type, 'side', 'low');
			add_meta_box( "local_featured_content_meta_box", 'Local Featured Content', array( &$this, 'local_featured_content_meta_box' ), $post_type, 'side', 'low');
		}
	...
	function global_featured_content_meta_box( $post ) {
		...
		<p>
			...
			<label for="vc_featured">Featured</label>
		</p>
		
		<p>
			<input style="width:35px;" id="vc_featured_priority" name="_vc_featured_priority" type="text" value="<?php echo $vc_featured_priority; ?>" />
			<label for="vc_featured_priority">Priority</label>
		</p>
		
		<p class="description">Content that has been tagged with "Global Featured Content" will be featured with other post-type content.</p>
	...
	function local_featured_content_meta_box( $post ) {
		...
		<p class="vc-<?php echo $post->post_type; ?>-featured">
			...
			<label for="vc_<?php echo $post->post_type; ?>_featured">Local Featured</label>
		</p>
		...
		<p class="vc-<?php echo $post->post_type; ?>-featured-priority">
			...
			<label for="vc_<?php echo $post->post_type; ?>_featured_priority">Priority</label>
		</p>
		
		<p class="description">Content that has been tagged with "Local Featured Content" will be local to this post-type content.</p>
